...
/**
  * A [[Rook]].
  */
final case class Rook(color: Color, atPos: Square) extends Piece {
  ...
  /**
    * Resolves whether given [[Square]] is reachable by 'this' [[Rook]].
    * @param to [[Square]] whose reachability is to be determined
    * @param at [[Board]] to be used for validation
    * @return 'True' if given [[Square]] is reachable by 'this' [[Rook]],
    *         'false' otherwise
    */
